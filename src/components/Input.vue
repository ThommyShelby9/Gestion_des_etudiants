<template>
    <div class="block">
        <form action="">
            <h4>Inscription</h4>
            <input type="text" id="name" placeholder="Nom de l'\établissement" v-model="add.nomEtablissement"><br>
            <input type="email" name="" id="email" placeholder="Email" v-model="add.email"><br>
            <input type="text" id="registre" placeholder="Régistre de commerce" v-model="add.registre_de_commerce"><br>
        ...
        <button type="submit" id="submit" @click="createUser">Envoyer</button>
    </div>
</template>
